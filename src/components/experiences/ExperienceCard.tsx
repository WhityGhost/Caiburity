...
const Experience = ({
  ...
  return (
    ...
    >
      ...
      <span className="z-20 flex items-center order-1 justify-center w-6 h-6 md:w-9 md:h-9 bg-cyan-200 rounded-full ring-4 md:ring-8 ring-white dark:ring-grey-800 dark:bg-cyan-900">
        {company && (
          <MdWork className="text-base md:text-xl text-cyan-600 dark:text-cyan-400" />
        )}
        {institute && (
          <MdSchool className="text-base md:text-xl text-cyan-600 dark:text-cyan-400" />
        )}
      </span>
